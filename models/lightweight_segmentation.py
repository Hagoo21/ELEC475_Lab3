...
THIS IS THE ORIGINAL VERSION (6.83M parameters)
For the optimized version (2.52M parameters), see lightweight_segmentation.py
"""
...
if __name__ == "__main__":
    ...
    """
    print("Testing ORIGINAL Lightweight Segmentation Model...\n")
    ...
    print(f"\n[ORIGINAL MODEL] {total/1e6:.2f}M parameters")
    print(f"[INFO] This is the version that achieved 58.03% mIoU")
